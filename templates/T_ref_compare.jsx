/* Template ref-compare — Reference AD vs Agent Opus (black canvas, two portrait clips with headings) */
(function () {
  ...
  window.TEMPLATES.push({
    id: "ref-compare",
    name: "Reference AD vs Agent Opus",
    width: 1080,
    height: 840,
    slots: 2,
    desc: "Black canvas with two portrait clips side by side: the reference ad next to the Agent Opus result, headings above each.",
    Component
  });
})();
