    ...
    return (
      <div className="relative overflow-hidden bg-[#38295C]" style={{ width: 1080, height: 1920 }}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-[960px]">
          {/* heading: mark + collab title */}
          <div className="flex items-center gap-[22px]">
            <LogoSlot k="l1" className="shrink-0 size-[84px]" />
            <div data-swap="title" className="flex items-center justify-center h-[84px]">
              {labelText.title === "@logo"
                ? <img src={window.__AO_LOGO} alt="Agent Opus" className="invert h-[64px] object-contain" />
                : <p className="font-semibold leading-none text-[68px] text-[#f3ede2] tracking-[-0.5px] font-[Geist,sans-serif] whitespace-nowrap">{(labelText.title && labelText.title !== "@logo") ? labelText.title : "Claude X Agent Opus"}</p>}
            </div>
          </div>
