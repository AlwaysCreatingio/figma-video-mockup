        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex gap-[24px] items-center">
          ...
          <div className="relative w-[360px] h-[440px] rounded-[20px] bg-[#212124] border border-[#3a3a40] p-[26px] flex flex-col shrink-0">
            <div className="inline-flex items-center gap-[8px] self-start px-[12px] py-[9px] rounded-[8px]" style={pillBg}>
              ...
              <p className="font-medium leading-none text-[14px] text-white tracking-[0.42px] uppercase" style={{ fontFamily: "'Geist', sans-serif" }}>Prompt</p>
            </div>
            <p className="mt-[22px] text-[#f0f0f2] text-[23px] leading-[1.4] font-medium tracking-[-0.1px]" style={{ fontFamily: "'Geist', sans-serif" }}>
              A cinematic product ad — slow-motion splash, studio lighting, ultra-detailed 4K.
            </p>
            <p className="mt-auto text-[13px] text-neutral-500 font-medium" style={{ fontFamily: "'Geist', sans-serif" }}>One prompt. One take.</p>
          </div>

          {/* arrow */}
          <div className="shrink-0 text-neutral-400 flex items-center justify-center w-[40px]">
            <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 12h15"/><path d="M13 6l6 6-6 6"/></svg>
          </div>
