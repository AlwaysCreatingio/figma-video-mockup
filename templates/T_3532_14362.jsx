/* Template 3532-14362 — 9:16 Brand Collab Comment CTA */
(function () {
    ...
    return (
      <div className="relative overflow-hidden bg-[#101010]" style={{ width: 594, height: 1056 }}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col gap-[34px] items-center w-[522.941px]">
          ...
          {/* centered phone video slot */}
          <Slot k="slotMAIN" className="bg-white shrink-0 w-[286.47px] aspect-[1080/1920]" />
  ...
  window.TEMPLATES.push({ id: "3532-14362", name: "9:16 Brand Collab Comment CTA", width: 594, height: 1056, slots: 1, logoSlots: 2, desc: "Two brand logo tiles plus a phone-screen video over a blurred gradient with a 'Comment Agent Opus' caption", Component });
})();
