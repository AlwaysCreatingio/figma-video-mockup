/* Template gallery-9x16 — Gallery Stack 9:16 */
(function () {
    ...
    return (
      <div className="relative overflow-hidden bg-black" style={{ width: 1080, height: 1920 }}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-[960px]">
          {Wordmark({ swap: "title" })}
          <Slot k="slot1" className="mt-[36px] w-full h-[500px] bg-[#9f9f9f]" />
          <div className="mt-[36px] flex gap-[36px] w-full justify-center">
            <Slot k="slot2" className="w-[400px] h-[500px] bg-[#8f8f8f]" />
            <Slot k="slot3" className="w-[400px] h-[500px] bg-[#8f8f8f]" />
          </div>
          <Slot k="slot4" className="mt-[36px] w-full h-[500px] bg-[#9f9f9f]" />
        </div>
      </div>
    );
  }
  ...
  window.TEMPLATES.push({
    id: "gallery-9x16",
    name: "Gallery Stack 9:16",
    width: 1080,
    height: 1920,
    slots: 4,
    desc: "Vertical gallery on black: Agent Opus wordmark, a wide clip, two portrait frames, and a closing wide clip.",
    Component
  });
})();
