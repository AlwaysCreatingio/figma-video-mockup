/* Template collab-1x1 — Product Collab 1:1 (video on top; brand + uploadable product shot + partner below) */
(function () {
  ...
  window.TEMPLATES.push({
    id: "collab-1x1",
    name: "Product Collab 1:1",
    width: 1080,
    height: 1080,
    slots: 2,
    logoSlots: 2,
    desc: "Square layout: the ad video on top, and brand + uploadable product shot + partner logos joined by plus signs on white below.",
    Component
  });
})();
