/* Template brief-16x9 — Prompt + Refs 16:9 */
(function () {
  function Component(props) {
    ...
    return (
      <div data-brief className="relative overflow-hidden bg-[#0f0f13]" style={{ width: 1280, height: 720 }}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex gap-[48px] items-center">
          ...
          <div className="flex flex-col w-[230px]">
            <p className="font-bold leading-none text-[26px] text-white tracking-[1.2px] uppercase font-[Geist,sans-serif]">References</p>
            <Slot k="slot2" className="mt-[20px] w-[230px] h-[230px] rounded-[16px] bg-[#26262b]" />
            <Slot k="slot3" className="mt-[24px] w-[230px] h-[230px] rounded-[16px] bg-[#26262b]" />
          </div>
        </div>
      </div>
    );
  ...
  window.TEMPLATES.push({
    id: "brief-16x9",
    name: "Prompt + Refs 16:9",
    width: 1280,
    height: 720,
    slots: 3,
    desc: "Widescreen brief: the 9:16 result on the left, the prompt in the middle, and two reference images on the right. The prompt scrolls with playback.",
    Component
  });
})();
