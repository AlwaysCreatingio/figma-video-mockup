      ...
      <div className="relative bg-[#181818] overflow-hidden" style={{ width: 594, height: 1056 }}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-[42px] items-center w-[522.941px]">
          {logosHidden
            ...
            : <div data-logogroup className="relative group flex gap-[20px] items-center"><LogoSlot k="logo1" className="bg-white rounded-[15.75px] size-[90px]" /><div className="relative size-[34px]"><span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-[34px] leading-none font-light">+</span></div><LogoSlot k="logo2" className="bg-white rounded-[15.75px] size-[90px]" /><button data-ctl title="Remove logos" onClick={() => setLogosHidden(true)} className="absolute -top-3 -right-3 z-30 w-6 h-6 flex items-center justify-center rounded-full bg-neutral-900 text-white text-[11px] leading-none opacity-0 group-hover:opacity-100 shadow hover:bg-neutral-700 transition">✕</button></div>}
